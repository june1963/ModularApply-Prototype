...
export const aiSuggestions: AISuggestion[] = [
  {
    ...
    blockId: 'work-2',
    field: 'content',
    suggestedValue: 'Microsoft (2019-2021): Led development of cloud-native microservices for Azure infrastructure, scaling to handle 10M+ daily requests. Architected distributed systems using Kubernetes and Docker.',
  },
  {
    id: 'sug-2',
    type: 'emphasize',
    ...
    field: 'content',
    suggestedValue: 'Led cross-functional team of 12 engineers on Google Cloud Infrastructure, mentoring 5 junior developers and driving technical roadmap for distributed systems serving billions of requests.',
  },
  {
    id: 'sug-3',
    type: 'quantify',
    ...
    blockId: 'work-2',
    field: 'content',
    suggestedValue: 'Microsoft (2019-2021): Implemented microservices architecture reducing system latency by 40% and increasing throughput by 3x. Built scalable cloud infrastructure handling 10M+ daily requests.',
  },
  {
    id: 'sug-4',
    type: 'add',
    ...
    blockId: 'work-1',
    field: 'content',
    suggestedValue: 'Google (2021-Present): Led development of cloud infrastructure platform serving 100M+ users with high-throughput streaming systems. Built distributed systems using Go and Kubernetes, reducing deployment time by 60% and optimizing video delivery pipelines. Managed team of 5 engineers.',
  },
];
